    ...
    def base_forward(
        ...
        if labels is not None:
            ...
            with torch.no_grad():
                ...
                shift_logits_w_img = torch.gather(shift_logits_w_img, 1, shift_labels_c.unsqueeze(1)) # n*b 1
                shift_logits_wo_img = torch.gather(shift_logits_wo_img, 1, shift_labels_c.unsqueeze(1).to(shift_logits_wo_img.device))
                ...
                sub = sub[0, 0]
                del shift_logits_wo_img, shift_logits_w_img, shift_labels_c
